...
class PronounsActivity : AppCompatActivity() {
    ...
    // TextToSpeech
    private val alphabetText = "SINGULAR: I   YOU   HE   SHE   IT / PLURAL: WE   YOU   THEY"
    ...
    private fun setupClickListeners() {
        ...
        eButtonListening!!.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                val intent = Intent(this@PronounsActivity, ListeningActivity::class.java)
    ...
    private fun ReturnMapA1() {
        startActivity(Intent(this@PronounsActivity, MenuA1Activity::class.java))
    ...
    companion object {
        private const val TAG = "PronounsActivity"
    }
}
