...
class ColorActivity : AppCompatActivity() {
    ...
    private val alphabetText =
        "Yellow   Blue   Red   Orange   Violet   Green   Pink   Brown   Gold   Gray   White   Black"
    ...
    private fun setupClickListeners() {
        ...
        eButtonListening!!.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                val intent = Intent(this@ColorActivity, ListeningActivity::class.java)
    ...
    private fun ReturnMapA1() {
        startActivity(Intent(this@ColorActivity, MenuA1Activity::class.java))
    ...
    companion object {
        private const val TAG = "ColorActivity"
    }
}
